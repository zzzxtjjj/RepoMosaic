...
from repomosaic.core.parser import parse_python_file
from repomosaic.core.symbols import RepositoryInfo, FileInfo
...
def analyze_repository(repo_path: str | Path) -> RepositoryInfo:
    ...
    for relative_path in scanned_files:
        ...
        # FileInfo 中只保存相对于仓库根目录的路径 给 RepoMosaic 保存、展示、生成链接
