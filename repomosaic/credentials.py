"""Resolve and manage RepoMosaic's single user-level API credential."""
...
SERVICE_NAME = "repomosaic"
ACCOUNT_NAME = "default"
API_KEY_ENVIRONMENT_VARIABLE = "REPOMOSAIC_API_KEY"
...
def clear_stored_api_key() -> bool:
    """仅删除 RepoMosaic 默认凭据；不存在时返回 False。"""
